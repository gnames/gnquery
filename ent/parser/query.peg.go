...
func (p *Engine) Init(options ...func(*Engine) error) error {
	...
	_rules = [...]func() bool{
		...
		/* 6 TagWord <- <((Author / DataSource / Genus / NameString / ParentTaxon / Species / SpeciesAny / SpeciesInfra / Uninomial / Year) ':')> */
		func() bool {
